...
public class AdminController : Controller
{
    ...
    public AdminController(UserManager<ApplicationUser> userManager, IUserRepository userRepository, IAccountService accountService, IAccountRepository accountRepository, SignInManager<ApplicationUser> signInManager)
    {
    ...
    [Authorize(Roles = "Adminstrator, Staff")]
    public async Task<IActionResult> Edit(string id, UserDetailModel user)
    {
